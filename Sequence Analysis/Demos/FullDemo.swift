      ...
      VStack(alignment: .leading) {
        ...
        VStack(alignment: .center) {
          Text("Test Mixed Glyphs")
            .font(.title)
          Text(String("Window: \(F.f(windowWidth, decimal: 0))"))
          Text(String("Scale: \(F.f(scale, decimal: 2))"))
...
//      style.barColor = "Green"
  //      style.lblPosition = "Inside"
    ...
    // Green Mosaic
    let greenMosaic = Mosaic(tiles: [], layout: TileLayout(), color: "green")
